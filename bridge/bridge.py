...
SLOT_PAY_PAIR = 1.4           # два одинаковых — ставка возвращается с прибавкой
# Отдача при шести символах: тройка 6/216, пара 90/216, итого 15/36 + 1.4*90/216 = 1.0
# РОВНО — при ставке 5 округление выплат целыми баллами тоже сходится точно (75 и 7).
# Ноль выбран сознательно: при 81% игрок уходил в минус на любой дистанции, а автомат
# тут не казино — он раскачивает счёт, а не съедает его. Но нулевое матожидание не
# значит «половина в плюсе»: плюс делается редкими тройками (2.8% спинов), поэтому
# медиана сотни спинов всё равно чуть ниже нуля, а 55.6% спинов — мимо.
